...
## Project Structure
    ...
    ├── whole_world_charity_32360  # Django project configurations
...
1. Clone this repo and `cd whole_world_charity_32360`
...
2. Clone this repo and `cd whole_world_charity_32360`
